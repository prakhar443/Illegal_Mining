...
\begin{figure}[t]
\centering
% ---- FIGURE: auto-generated by scripts/make_figures.py (fig_dataset_map.pdf) ----
\fbox{\begin{minipage}[c][0.24\textheight][c]{0.92\linewidth}\centering
\textit{[Figure~\ref{fig:map}: world map of the \num{1514} dataset sites, artisanal
($n=329$, triangles) vs.\ industrial ($n=1185$, circles). Insert the auto-generated
\texttt{figures/fig\_dataset\_map.pdf}.]}
\end{minipage}}
...
\begin{figure}[t]
\centering
% ---- FIGURE: auto-generated by scripts/make_figures.py (fig_efficiency.pdf) ----
\fbox{\begin{minipage}[c][0.22\textheight][c]{0.80\linewidth}\centering
\textit{[Figure~\ref{fig:efficiency}: mIoU vs.\ parameters (log scale); SPEAR-Net variants
(A1--A5, circles) vs.\ baselines (B1--B3, squares). Insert the auto-generated
\texttt{figures/fig\_efficiency.pdf}.]}
\end{minipage}}
...
\begin{figure}[t]
\centering
% ---- FIGURE: auto-generated by scripts/make_figures.py (fig_ablation.pdf) ----
\fbox{\begin{minipage}[c][0.20\textheight][c]{0.86\linewidth}\centering
\textit{[Figure~\ref{fig:ablbars}: grouped bars of mIoU, artisanal IoU and industrial IoU
for variants A1--A5. Insert the auto-generated \texttt{figures/fig\_ablation.pdf}.]}
\end{minipage}}
...
\begin{figure}[t]
\centering
% ---- FIGURE: auto-generated by scripts/make_figures.py (fig_area_recall.pdf) ----
\fbox{\begin{minipage}[c][0.18\textheight][c]{0.60\linewidth}\centering
\textit{[Figure~\ref{fig:areabars}: bar chart of component recall by area bin
(Eq.~\ref{eq:areastrat}). Insert the auto-generated \texttt{figures/fig\_area\_recall.pdf}.]}
\end{minipage}}
